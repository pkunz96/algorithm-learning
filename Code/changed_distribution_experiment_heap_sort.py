...
def sample(size: int, mu: int, sigma: int) -> Tuple[NDArray, NDArray, Dict[int, str]]:
    x_data, y_data, local_label_name_dict, = generate_training_data_record(heap_sort, gen_heap_sort_environment, lambda x: "T_{0}".format(x), size, mu, sigma)
...
experiment_name = "changed_distribution_experiment_heap_sort_changed_mu_0_sigma_150"
